...
const getFallbackResponse = (message: string): string => {
  ...
  const responses: Record<string, string> = {
    ...
    'ما هي الأسهم': 'الأسهم هي مثل قطع صغيرة م�� الشركات! 🧩 عندما تشتري سهماً، تصبح مالكاً لجزء صغير من تلك الشركة. مثل لو كان لديك قطعة من كعكة كبيرة! 🍰',
  ...
  return 'هذا سؤال رائع! 🌟 أنا ��تخصص في تعليم الأموال والأسهم للأطفال. هل يمكنك أن تسأل عن شيء متعلق بالمال أو الأسهم؟ مثل "ما هي الأسهم؟" أو "كيف أوفر المال؟" 💰📚';
};
...
8. شجع الأطفال على الادخار والتفكير الإيجابي نحو المال
...
إذا لم يكن السؤا�� عن المال، أجب فقط بالرد المحدد في القاعدة 5.
