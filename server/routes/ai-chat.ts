...
const getFallbackResponse = (message: string): string => {
  ...
  const responses: Record<string, string> = {
    ...
    'ما هي الأسهم': 'الأسهم هي مثل قطع صغيرة من الشركات! 🧩 عندما تشتري سهماً، تصبح مالكاً لجزء صغير من تلك الشركة. مثل لو كان لديك قطعة من كعك�� كبيرة! 🍰',
    ...
    'ما هي ال��ورصة': 'البورصة مثل سوق كبير للأسهم! 🏪 الناس يأتون ليشتروا ويبيعوا أجزاء من الشركات. مثل سوق الخضار لكن للأسهم! 📊'
  };
  ...
  return 'هذا سؤال رائع! 🌟 أنا أتخصص في تعليم الأموال والأسهم للأطفال. هل يمكنك أن تسأل عن شيء متعلق بالمال أو الأسهم؟ مثل "ما ��ي الأسهم؟" أو "كيف أوفر المال؟" 💰📚';
};
