...
const getFallbackResponse = (message: string): string => {
  ...
  const responses: Record<string, string> = {
    ...
    'مرحبا': 'مرحباً بك! أنا مسا��دك الذكي لتعلم الأسهم والمال بطريقة سهلة وممتعة! 🌟 اسألني أي سؤال عن المال!',
    ...
    'تضارب': 'التضارب هو شراء وبيع الأسهم بسرعة لربح سريع! 🎢 مثل شراء لعبة اليوم بـ10 ريال وبيعها غداً ��ـ15 ريال. لكن احذر! قد تنخفض لـ5 ريال! إنها مثل لعبة محفوفة بالمخاطر! 🎯⚠️',
