...
const fallbackResponses: Record<string, string> = {
  ...
  'السلام عليكم': 'وعليكم السلام ورحمة الله وبركاته! كيف يمكنني مساعدتك في تع��م الأموال اليوم؟ 😊',
  ...
  'ما معنى تضارب': 'التضارب هو شراء وبيع الأسهم بسرعة لربح سريع! 🎢 مثل شراء لعبة اليوم بـ10 ريال وبيعها غداً بـ15 ريال. لكن احذر! قد تنخفض لـ5 ريال! إنها مثل لعبة محفوفة بالمخاطر! 🎯⚠️',
...
export default function FinanceChatbot() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'مرحباً بك في سَعه! 🏫💰 أنا هنا لأعلمك كل شيء عن الأموال والأسهم بطريقة سهلة وممتعة! اسألني أي سؤال عن المال! 🌟',
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-orange-50 to-orange-100" dir="rtl">
      ...
      <div className="bg-white shadow-sm border-b border-orange-200 p-4">
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">سَعه</h1>
